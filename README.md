...
The extension sends your Git diff to the Ollama server configured in `ollamacommit.baseUrl`.

If you run Ollama locally, your data stays in your local environment.
